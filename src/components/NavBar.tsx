...
export const NavBar = (props: {openMenu: boolean, HandlerOpenMenu: () => void, closeApresentation: boolean, HandlerOpenSide: (side: string) => void}) => {
    ...
    return (
        ...
        <div className='fixed w-screen h-fit p-2 flex justify-center items-center text-black z-50'>
            <div 
                className="z-10 absolute left-2 top-2 laptop:left-[2px] laptop:top-[2px] transition-all duration-500 ease-in-out">
                <Hamburger 
                    color="#fff" 
                    easing="ease-in" 
                    rounded 
            ...
            <div className='absolute right-2 top-2 laptop:right-1 laptop:top-1'>
                <img src={avatar} alt="avatar" className='w-12 laptop:w-10 border-2 rounded-full border-purple-700'/>
            </div>
        </div>
    );
};